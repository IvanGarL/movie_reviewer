...
export class InitialDbSchema1691601504770 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "review" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" numeric(2,1) NOT NULL DEFAULT '0', "comment" text NOT NULL, "movie_tmdb_id" character varying NOT NULL, "user_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "movieTMDBId" uuid, CONSTRAINT "CHK_5f8cdef771c3e623bcee4ac405" CHECK (rating >= 0 AND rating <= 10), CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
